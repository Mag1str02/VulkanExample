...
public:                                           \
    ...
    S_METHOD_DEF(Void, Initialize, ());           \
    S_METHOD_DEF(Void, Terminate, ());
...
#define S_INITIALIZE()                                                                  \
    Void CurrentSingleton::Initialize() {                                               \
    ...
    Void CurrentSingleton::IInitialize()
#define S_TERMINATE()                                                                          \
    Void CurrentSingleton::Terminate() {                                                       \
    ...
    Void CurrentSingleton::ITerminate()
